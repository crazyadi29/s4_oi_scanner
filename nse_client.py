...
class NSEClient:
    ...
    def _get_fo_movers_rest(self, min_pct: float) -> list[dict]:
        ...
        fo_symbols = [
            ...
            "NSE:ABFRL-EQ","NSE:ACC-EQ","NSE:ADANIENT-EQ","NSE:ADANIGREEN-EQ",
            "NSE:ADANIPORTS-EQ","NSE:ADANIPOWER-EQ","NSE:ALKEM-EQ","NSE:AMBUJACEM-EQ",
            "NSE:APOLLOHOSP-EQ","NSE:APOLLOTYRE-EQ","NSE:ASHOKLEY-EQ","NSE:ASIANPAINT-EQ",
            "NSE:ASTRAL-EQ","NSE:ATGL-EQ","NSE:AUBANK-EQ","NSE:AUROPHARMA-EQ",
            "NSE:AXISBANK-EQ","NSE:BAJAJ-AUTO-EQ","NSE:BAJAJFINSV-EQ","NSE:BAJFINANCE-EQ",
            "NSE:BALKRISIND-EQ","NSE:BANDHANBNK-EQ","NSE:BANKBARODA-EQ","NSE:BATAINDIA-EQ",
            "NSE:BEL-EQ","NSE:BERGEPAINT-EQ","NSE:BHARTIARTL-EQ","NSE:BHEL-EQ",
            "NSE:BIKAJI-EQ","NSE:BIOCON-EQ","NSE:BPCL-EQ","NSE:BRITANNIA-EQ",
            "NSE:BSE-EQ","NSE:CANBK-EQ","NSE:CANFINHOME-EQ","NSE:CHOLAFIN-EQ",
            "NSE:CIPLA-EQ","NSE:COALINDIA-EQ","NSE:COFORGE-EQ","NSE:COLPAL-EQ",
            "NSE:CONCOR-EQ","NSE:CROMPTON-EQ","NSE:CUMMINSIND-EQ","NSE:DABUR-EQ",
            "NSE:DALBHARAT-EQ","NSE:DEEPAKNTR-EQ","NSE:DELHIVERY-EQ","NSE:DIXON-EQ",
            "NSE:DLF-EQ","NSE:DMART-EQ","NSE:DRREDDY-EQ","NSE:EICHERMOT-EQ",
            "NSE:EMAMILTD-EQ","NSE:ESCORTS-EQ","NSE:EXIDEIND-EQ","NSE:FEDERALBNK-EQ",
            "NSE:FLUOROCHEM-EQ","NSE:FORTIS-EQ","NSE:GAIL-EQ","NSE:GMRAIRPORT-EQ",
            "NSE:GMRINFRA-EQ","NSE:GNFC-EQ","NSE:GODREJCP-EQ","NSE:GODREJPROP-EQ",
            "NSE:GRANULES-EQ","NSE:GRASIM-EQ","NSE:HAL-EQ","NSE:HAVELLS-EQ",
            "NSE:HCLTECH-EQ","NSE:HDFCAMC-EQ","NSE:HDFCBANK-EQ","NSE:HDFCLIFE-EQ",
            "NSE:HEROMOTOCO-EQ","NSE:HINDALCO-EQ","NSE:HINDCOPPER-EQ","NSE:HINDPETRO-EQ",
            "NSE:HINDUNILVR-EQ","NSE:HUDCO-EQ","NSE:ICICIBANK-EQ","NSE:ICICIGI-EQ",
            "NSE:ICICIPRULI-EQ","NSE:IDFCFIRSTB-EQ","NSE:IEX-EQ","NSE:IGL-EQ",
            "NSE:INDHOTEL-EQ","NSE:INDIGO-EQ","NSE:INDUSINDBK-EQ","NSE:INDUSTOWER-EQ",
            "NSE:INFY-EQ","NSE:IOC-EQ","NSE:IRCTC-EQ","NSE:IRFC-EQ",
            "NSE:ITC-EQ","NSE:JINDALSTEL-EQ","NSE:JKCEMENT-EQ","NSE:JSWENERGY-EQ",
            "NSE:JSWSTEEL-EQ","NSE:JSWINFRA-EQ","NSE:JUBLFOOD-EQ","NSE:KALYANKJIL-EQ",
            "NSE:KEI-EQ","NSE:KOTAKBANK-EQ","NSE:KPITTECH-EQ","NSE:LAURUSLABS-EQ",
            "NSE:LICHSGFIN-EQ","NSE:LT-EQ","NSE:LTIM-EQ","NSE:LTTS-EQ",
            "NSE:LUPIN-EQ","NSE:M&M-EQ","NSE:MANKIND-EQ","NSE:MANAPPURAM-EQ",
            "NSE:MARICO-EQ","NSE:MARUTI-EQ","NSE:MAXHEALTH-EQ","NSE:MCX-EQ",
            ...
            "NSE:ONGC-EQ","NSE:PAGEIND-EQ","NSE:PATANJALI-EQ","NSE:PAYTM-EQ",
            "NSE:PERSISTENT-EQ","NSE:PETRONET-EQ","NSE:PFC-EQ","NSE:PIDILITIND-EQ",
            "NSE:PIIND-EQ","NSE:PNB-EQ","NSE:POLICYBZR-EQ","NSE:POLYCAB-EQ",
            "NSE:POONAWALLA-EQ","NSE:POWERGRID-EQ","NSE:PRESTIGE-EQ","NSE:PVRINOX-EQ",
            "NSE:RBLBANK-EQ","NSE:RECLTD-EQ","NSE:RELIANCE-EQ","NSE:RVNL-EQ",
            "NSE:SAIL-EQ","NSE:SBICARD-EQ","NSE:SBILIFE-EQ","NSE:SBIN-EQ",
            "NSE:SHREECEM-EQ","NSE:SHRIRAMFIN-EQ","NSE:SIEMENS-EQ","NSE:SJVN-EQ",
            "NSE:SOLARINDS-EQ","NSE:SRF-EQ","NSE:SUNPHARMA-EQ","NSE:SUNTV-EQ",
            "NSE:SUPREMEIND-EQ","NSE:SYNGENE-EQ","NSE:TATACHEM-EQ","NSE:TATACOMM-EQ",
            "NSE:TATACONSUM-EQ","NSE:TATAELXSI-EQ","NSE:TATAMOTORS-EQ","NSE:TATAPOWER-EQ",
            "NSE:TATASTEEL-EQ","NSE:TCS-EQ","NSE:TECHM-EQ","NSE:TIINDIA-EQ",
            "NSE:TITAN-EQ","NSE:TORNTPHARM-EQ","NSE:TRENT-EQ","NSE:TVSMOTOR-EQ",
            "NSE:UBL-EQ","NSE:ULTRACEMCO-EQ","NSE:UNIONBANK-EQ","NSE:UPL-EQ",
            "NSE:VEDL-EQ","NSE:VOLTAS-EQ","NSE:WIPRO-EQ","NSE:ZOMATO-EQ",
            "NSE:ZYDUSLIFE-EQ","NSE:ANGELONE-EQ","NSE:CAMS-EQ","NSE:CDSL-EQ",
            "NSE:IREDA-EQ","NSE:IRCON-EQ","NSE:NBCC-EQ","NSE:MAZDOCK-EQ",
            "NSE:COCHINSHIP-EQ","NSE:BDL-EQ","NSE:GRSE-EQ","NSE:TITAGARH-EQ",
            "NSE:RITES-EQ",
        ]
        movers = []
